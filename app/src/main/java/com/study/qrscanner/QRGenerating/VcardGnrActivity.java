...
public class VcardGnrActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnstore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(VcardGnrActivity.this, ScannerActivity.class);
                startActivity(i);
                Toast.makeText(VcardGnrActivity.this, "QR code stored in gallery", Toast.LENGTH_LONG).show();
