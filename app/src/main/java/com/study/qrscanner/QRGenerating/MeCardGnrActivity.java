...
import com.study.qrscanner.ScannerActivity;

import java.io.File;
import java.io.FileOutputStream;
import java.util.Random;

public class MeCardGnrActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_me_card_gnr);
        ...
        btnstore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(MeCardGnrActivity.this, ScannerActivity.class);
                startActivity(i);
                Toast.makeText(MeCardGnrActivity.this, "QR code stored in gallery", Toast.LENGTH_LONG).show();
