...
public class MarketGnrActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_market_gnr);
        ...
        btnstore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i=new Intent(MarketGnrActivity.this, ScannerActivity.class);
                startActivity(i);
                Toast.makeText(MarketGnrActivity.this, "QR code stored in gallery", Toast.LENGTH_LONG).show();
